      ...
      <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
        <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
          <div className="md:w-[316px]">
            ...
            <div className="mt-[18px] flex gap-4">
              <a className="hover:scale-110" target="_blank" href="#">
                <img alt="facebook icon" width="36" height="36" src="https://www.englishyaari.com/img/facebook.svg" />
              </a>
              <a className="hover:scale-110" target="_blank" href="/">
                <img alt="linkedin icon" width="36" height="36" src="https://www.englishyaari.com/img/linkdin.svg" />
              </a>
              <a className="hover:scale-110" target="_blank" href="/">
                <img alt="instagram icon" width="36" height="36" src="https://www.englishyaari.com/img/instagram1.svg" />
              </a>
              <a className="hover:scale-110" target="_blank" href="/">
                <img alt="twitter icon" width="36" height="36" src="https://www.englishyaari.com/img/twitter.svg" />
              </a>
              <a className="hover:scale-110" target="_blank" href="https://www.youtube.com/">
                <img alt="youtube icon" width="36" height="36" src="https://www.englishyaari.com/img/youtube.svg" />
              </a>
            </div>
          </div>
          <div className="md:w-[316px]">
          ...
          <div className="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[341px]">
            <div className="">
              <p className="text-deutziawhite font-inter text-[18px] font-bold sm:text-2xl md:text-[18px]">Quick Links</p>
              <div className="mt-3 flex flex-col gap-3 text-white">
                <a className="hover:text-rose-600">Privacy Policy</a>
                <a className="hover:text-rose-600">Terms of Use</a>
                <a className="hover:text-rose-600">About Us</a>
                <a className="hover:text-rose-600">Careers</a>
                <a className="hover:text-rose-600">Contact</a>
              </div>
            </div>
            <div className="">
              <p className="text-deutziawhite font-inter text-[18px] font-bold sm:text-2xl md:text-[18px]">Services</p>
              <div className="mt-3 flex flex-col gap-3 text-white">
                <a className="hover:text-rose-600">Marketing</a>
                <a className="hover:text-rose-600">Design</a>
                <a className="hover:text-rose-600">Branding</a>
                <a className="hover:text-rose-600">Consulting</a>
              </div>
            </div>
          </div>
        </div>
      </div>
      <div className="border-t-2 border-white px-4 py-3 text-center">
